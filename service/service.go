...
func GetDieters(req *gin.Context) {
	...
	if err == nil {
		...
		mutils.LogMessage(mutils.Request.String(), "Dieters retrieved and sent to user")
		return
	}
	...
	if err == nil {
		...
		if err == nil {
			...
			if err == nil {
				...
				mutils.LogMessage(mutils.Request.String(), "Dieter added")
			}
...
func GetMeal(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			mutils.LogMessage(mutils.Request.String(), "Responded with the meal requested")
			req.IndentedJSON(http.StatusOK, meals)
		}
	}
}
...
func SetMealCalories(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			mutils.LogMessage(mutils.Request.String(), "Updated meal calories")
...
func GetMealCalories(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			...
			mutils.LogMessage(mutils.Request.String(), "Responded with the meal calories requested")
			req.IndentedJSON(http.StatusOK, meal)
		}
	}
}
...
func AddEntry(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			mutils.LogMessage(mutils.Request.String(), "Added entry to the database")
...
func AddFood(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			mutils.LogMessage(mutils.Request.String(), "Added food to the database")
...
func EditFood(req *gin.Context) {
	...
	if err == nil {
		...
		if err == nil {
			mutils.LogMessage(mutils.Request.String(), "Calories updated for food")
			req.IndentedJSON(http.StatusOK, food)
		}
	}
}
